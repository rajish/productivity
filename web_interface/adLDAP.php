...
class adLDAP {
    ...
    protected $_ldap_ports = array ("389");
    ...
    public function set_ldap_ports(array $_ldap_ports)
    {
        $this->_ldap_ports = $_ldap_ports;
    }
    ...
    public function get_ldap_ports(array $_ldap_ports)
    {
        return $this->_ldap_ports = $_ldap_ports;
    }
    ...
    function __construct($options=array()){
        ...
        if (count($options)>0){
            ...
            if (array_key_exists("ldap_ports",$options)){ $this->_ldap_ports=$options["ldap_ports"]; }
    ...
    public function connect() {
        ...
        if ($this->_use_ssl){
            $this->_conn = ldap_connect("ldaps://".$dc['dc'], $dc['port']);
        } else {
            $this->_conn = ldap_connect($dc['dc'], $dc['port']);
        }
    ...
    *
    ...
    protected function random_controller(){
        ...
        $ind = array_rand($this->_domain_controllers);
        return array('dc' => $this->_domain_controllers[$ind], 'port' => $this->_ldap_ports[$ind]);
    }
